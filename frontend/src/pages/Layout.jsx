  ...
  return (
    <div className="w-full h-screen flex bg-white">
      ...
      <aside className="w-60 h-full fixed bg-zinc-700 flex flex-col items-center pb-6 justify-between z-10">
        <div className="mt-6">
          <img src="/LEAP logo.png" alt="LEAP Logo" className="h-20 w-auto" />
        </div>
...
>
  Saved Plans
        ...
        <div className="w-full flex flex-col items-center">
          <button className="w-48 h-12 bg-transparent rounded-md text-white text-xl hover:bg-neutral-200 transition">
            Account Settings
          </button>
          <button className="w-48 h-12 mt-2 bg-transparent rounded-md text-white text-xl hover:bg-neutral-200 transition">
            Privacy
          </button>
        </div>
      </aside>
